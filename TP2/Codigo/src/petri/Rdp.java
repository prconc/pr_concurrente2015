...
/* Clase que modela una Red de Petri.
 * Sus campos son: Un Matrix que posee la matriz de marcado.
 * 					Otro Matrix que posee la matriz de incidencia.
 */
...
public boolean probar_disparo(Matrix vector_disparo){
	...
	Matrix nuevo_marcado=new Matrix(marcado.getFil(),marcado.getCol());        //Creo una nueva matriz con el mismo tamaño que el marcado.
